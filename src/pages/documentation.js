...
function Documentation() {
  return (
    <div className="documentationDiv">
      ...
      <hr></hr>
      <p>We then repeat the 1-move adjacent search process, starting from the scrambled cube, adding these states to a second dictionary. Some examples:</p>
      <div className="cubeRow">
        <div className="cubeAndCaption">
      ...
      and more. </p>
      <p>As well as <a href="https://www.worldcubeassociation.org/persons/2006GARR01" target="_blank" rel="noopen noreferrer">Lucas Garron</a> and his co-contributors, for their beautiful <a href="https://js.cubing.net/cubing/" target="_blank" rel="noopener noreferrer">Rubik's Cube visual display.</a></p>
      <h2>Contributions</h2>
      <p>The code is fully open-source. If you would like to contribute, the Github repositories are here:&nbsp;
